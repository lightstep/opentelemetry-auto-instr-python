...
class Pin(object):
    ...
    def __init__(self, service, app=None, app_type=None, tags=None, tracer=None, _config=None):
        tracer = tracer or oteltrace.tracer
        self.app = app
    ...
    def _find(*objs):
        """
        Return the first :class:`oteltrace.pin.Pin` found on any of the provided objects or `None` if none were found


            >>> pin = Pin._find(wrapper, instance, conn, app)

        :param *objs: The objects to search for a :class:`oteltrace.pin.Pin` on
        :type objs: List of objects
        :rtype: :class:`oteltrace.pin.Pin`, None
        :returns: The first found :class:`oteltrace.pin.Pin` or `None` is none was found
        """
        for obj in objs:
    ...
    def get_from(obj):
        ...
        :param obj: The object to look for a :class:`oteltrace.pin.Pin` on
        :type obj: object
        :rtype: :class:`oteltrace.pin.Pin`, None
        :returns: :class:`oteltrace.pin.Pin` associated with the object, or None if none was found
        """
