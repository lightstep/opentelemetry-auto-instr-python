...
from oteltrace.contrib.base_contrib import BaseContrib
...
class AioHttpContrib(BaseContrib):
    ...
    def patch(self):
        ...
        if template_module:
            ...
            Pin(app='aiohttp', service=None, app_type='web').onto(
                aiohttp_jinja2
            )
