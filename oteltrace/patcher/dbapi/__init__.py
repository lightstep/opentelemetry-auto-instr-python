...
class TracedCursor(wrapt.ObjectProxy):
    ...
    def _trace_method(self, method, name, resource, extra_tags, *args, **kwargs):
        ...
        with pin.tracer.trace(name, service=service, resource=resource) as s:
            ...
            # https://github.com/opentelemetry/datadog-trace-agent/blob/bda1ebbf170dd8c5879be993bdd4dbae70d10fda/obfuscate/sql.go#L232
            s.set_tags(pin.tags)
    ...
    def execute(self, query, *args, **kwargs):
        ...
        # DEV: Some libraries return `None`, others `int`, and others the cursor objects
        #      These differences should be overriden at the integration specific layer (e.g. in `sqlite3/patch.py`)
        return self._trace_method(self.__wrapped__.execute, self._self_opentelemetry_name, query, {}, query, *args,
                                  **kwargs)
