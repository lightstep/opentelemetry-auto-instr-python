...
def trace_engine(engine, tracer=None, service=None):
    ...
    :param oteltrace.Tracer tracer: a tracer instance. will default to the global
    :param str service: the name of the service to trace.
    """
    tracer = tracer or oteltrace.tracer  # by default use global
...
def _wrap_create_engine(func, module, args, kwargs):
    ...
    EngineTracer(oteltrace.tracer, None, engine)
    return engine
