...
class TraceMiddleware(object):
    ...
    def __init__(self, app, tracer, service='flask', use_signals=True, distributed_tracing=False):
        ...
        # instrumentation happens (i.e. `oteltrace-run` with `TraceMiddleware`). In that
        # case, `oteltrace-run` instruments the application, but then users code is unable
        ...
        # See https://github.com/opentelemetry/otel-trace-py/issues/390
    ...
    def _finish_span(self, span, exception=None):
        ...
        # See case https://github.com/opentelemetry/otel-trace-py/issues/353
