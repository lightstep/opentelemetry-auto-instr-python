...
class Tracer(object):
    ...
    def get_call_context(self, *args, **kwargs):
        ...
        code during manual instrumentation like::
            ...
            from oteltrace import import tracer
    ...
    def start_span(self, name, child_of=None, service=None, resource=None, span_type=None):
        ...
        if trace_id:
            ...
            if not isinstance(self.sampler, OpenTelemetrySampler):
                if span.sampled:
    ...
    def set_service_info(self, *args, **kwargs):
        ...
        :param str service: the internal name of the service (e.g. acme_search, opentelemetry_web)
